...
<template>
  <div class="flex flex-col justify-between bg-[#FEF9EF] h-screen">
    <!-- Back to Menu page -->
    <button class="absolute top-2 left-2" @click="$router.push({ name: 'menu-page' })">
      <img
        :src="HomeIcon"
        alt="Go to menu page"
    ...
    <section id="gameplay-main-component" class="flex flex-col items-center justify-center">
    ...
    <section id="gameplay-tools-component" class="flex justify-center items-end mb-16 gap-10">
      <button
